export default function DayChip({ date, data }) {
	return (
		<div className='py-1 w-full flex justify-between items-center'>
			<div className='flex gap-3'>
				<div className='w-10 h-10 p-2 bg-slate-400/20 rounded-lg'>
			...
			<div className='border-l border-gray-400 px-3'>{data.main.temp}°C</div>
		</div>
	);
}
